...
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 4.1,  bezier = "quick",         style = "slide bottom" })
...
hl.animation({ leaf = "workspaces",    enabled = true,  speed = 1.94, bezier = "default", style = "slidefade" })
